...
class VideoResizer:
    ...
    Resize videos của BTC về 2 kích thước:
        - video-tiny: -DECRAPTED 146x? (width=146, height=-2) - Dùng khi nhấp chuột vào ảnh để xem nội dung xung quanh frame đó
    ...
    def resize_one(self, video_path: Path, output_medium: Path):
        ...
        if (output_medium.exists()) and not self.force:
