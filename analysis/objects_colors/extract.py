...
from analysis.common.extractor import BaseExtractor
...
def load_image(image_path):
    try:
        ...
        raise e
    # except:
    #     logging.warning(f'{image_path}: Error loading image')
    #     return None
...
class ColorExtractor(BaseExtractor):
    ...
    def setup(self):
        ...
        self.josa_map = read_color_table('./services/analysis/objects_colors/tables/LUT_JOSA.txt')
        self.w2c_map = read_color_table('./services/analysis/objects_colors/tables/w2c.txt')
...
"""
{
    'object_scores': [0.452, 0.621, 0.185, 0.350],
    'object_boxes_yxyx': [
        [0.0, 0.0, 0.142857, 0.142857],
        [0.428571, 0.571428, 0.571428, 0.714285],
        [0.428571, 0.571428, 0.571428, 0.714285],
        [0.857142, 0.857142, 1.0, 1.0]
    ],
    'object_class_names': ['white', 'blue', 'grey', 'red'],
    'detector': 'colors',
    'monochrome': 0.684211
}
"""
...
if __name__ == "__main__":
    ...
    extractor.run()
    # python -m services.analysis.objects_colors.extract ./dataset/L21_V001 jsonl -n objects-colors