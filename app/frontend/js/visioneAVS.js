...
function markTopVideoResultAsViewed(link) {
	var row = link ? link.closest(".video-result-row") : null;
	var thumbnail = row ? row.querySelector(".myimg-thumbnail[data-img-id]") : null;
	if (thumbnail) markResultLightboxItemAsViewed({ imgId: thumbnail.dataset.imgId });
}
